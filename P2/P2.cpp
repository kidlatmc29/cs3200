...
void makeCookieEntree()
{
  ...
  cout << "Total Carbs: " << cookie.getTotalCarbs() << endl;
  cout << "Fiber: " << cookie.getFiber() << endl;
...
void buyAndSell()
{
  cout << endl << "Buying and Selling Test..." << endl << endl;
  ...
  Entree soda1(soda1Name, soda1Ing, soda1Nutr, soda1Contains, "12/20/20", true, false);
